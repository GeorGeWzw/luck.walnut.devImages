...
# 构建预制Jenkins插件镜像
``` shell
docker build . -t registry.cn-hangzhou.aliyuncs.com/luck-walunt/luck-walunt-jenkins:2.361.3-lts-alpine
```
...
$ docker run \
  ...
  registry.cn-hangzhou.aliyuncs.com/luck-walunt/luck-walunt-jenkins:2.361.3-lts-alpine
